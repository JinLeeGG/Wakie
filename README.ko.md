...
게다가 이 글을 읽는 사람 절반이 그렇듯, 나도 계정을 하나만 쓰지 않는다. Claude Pro 2개, Codex Plus 1개 — 가난한 자의 Max 요금제다. 그러다 보니 어느 계정에 잔여량이 남았는지 확인하려고 하루 종일 로그인만 뺑뺑이 돌고, 내가 얼마나 쓰고 있는지도 모른 채 Claude, Codex, Antigravity에 쌩돈을 태우고 있었다. 대시보드도 없이 그냥 '느낌(vibes)'으로만. 그래서 깨우기 봇에다 사용량 트래킹을 냅다 볼트 체결해버렸다. 그다음 리셋 타이머. 그다음 모든 계정과 윈도우를 한눈에 보여주는 메뉴바 리드아웃.
